...
class ActorPendulum(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, fc1_units=400, fc2_units=300):
        ...
        ======
            ...
            fc2_units (int): Number of nodes in second hidden layer
        """
        super(ActorPendulum, self).__init__()
        self.seed = torch.manual_seed(seed)
...
class CriticPendulum(nn.Module):
    """Critic (Value) Model."""
    ...
    def __init__(self, state_size, action_size, seed, fcs1_units=400, fc2_units=300):
        ...
        ======
            ...
            fc2_units (int): Number of nodes in the second hidden layer
        """
        super(CriticPendulum, self).__init__()
        self.seed = torch.manual_seed(seed)
        self.fcs1 = nn.Linear(state_size, fcs1_units)
...
class Actor3(nn.Module):
    def __init__(self, state_size, action_size, seed=0, fc1=256, fc2=128, leak=0.01):
        """ Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
...
class Critic3(nn.Module):
    def __init__(self, state_size, action_size, seed=0, fc1=256, fc2=128, fc3=128, leak=0.01):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
